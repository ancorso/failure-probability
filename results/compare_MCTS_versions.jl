...
t_mcts_true, planner_true = run_mcts_trial(get_planner(mdp_true, Nstep, skip_terminal_branches = true), Nmax, failure_prob_fn = failure_prob)
t_mcts_true_cc, planner_true_cc = run_mcts_trial(get_planner(mdp_true, Nstep, skip_terminal_branches = true), Nmax, failure_prob_fn = failure_prob_cc)
...
plot_metric_comparisons([t_mcts_true, t_mcts_true_cc, t_mc,], ["MCTS Orig", "MCTS CC",  "MC",], V0)
